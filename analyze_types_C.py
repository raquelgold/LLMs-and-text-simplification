...
def load_llm_data(base_dir):
    ...
    for filename in expected_files:
        if os.path.exists(os.path.join(base_dir, filename)):
            llm_name = filename.replace('_C_output.csv', '')
...
def main():
    # Set directories
    base_input_dir = r'C:/Users/raque/Desktop/LaCC_READABILITY/Readability/output_analysis_LLM_answers/LLM_answers/LLM_C_analysis'
    base_output_dir = r'C:/Users/raque/Desktop/LaCC_READABILITY/Readability/output_analysis_LLM_answers/LLM_answers/output_plots_C'
